...
import HedgingInstrumentDetail from "./pages/HedgingInstrumentDetail";
      ...
      <ThemeProvider>
        <TooltipProvider>
          ...
          <Routes>
            ...
            <Route path="/hedging/instrument/:instrumentId" element={<ProtectedRoute><HedgingInstrumentDetail /></ProtectedRoute>} />
