...
function TradingViewWidget() {
  ...
  useEffect(() => {
    const updateDimensions = () => {
      ...
      // Hauteur proportionnelle (ratio ~2.2:1 pour les news)
  ...
  useEffect(() => {
    ...
    const allScripts = container.current.querySelectorAll('script[src*="embed-widget-timeline"]');
    ...
    return () => {
      ...
      if (container.current) {
        const scripts = container.current.querySelectorAll('script[src*="embed-widget-timeline"]');
