        ...
        <Tabs defaultValue="assistant" className="mt-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <Label className="text-sm font-medium">Affichage des données extraites (FX / Commodities)</Label>
            </div>
            <RadioGroup
          ...
          <div className="space-y-3">
            ...
            <Textarea
              ...
              placeholder="Ex: Réponds toujours en anglais, utilise des exemples concrets..."
          ...
          <TabsContent value="api" className="space-y-4 mt-6">
            <div className="rounded-lg border border-border bg-muted/30 p-4 space-y-3">
              <div className="flex items-center gap-2">
                ...
                <Label className="text-sm font-medium">Clé API Gemini 2.5 Flash</Label>
              </div>
              <p className="text-xs text-muted-foreground">
                Le chat utilise le modèle <strong>Gemini 2.5 Flash</strong>. Pour utiliser votre propre quota, saisissez votre clé API Google AI Studio (Generative Language API). Sinon, le service par défaut est utilisé.
              </p>
              <Input
                type="password"
                id="gemini-api-key"
              ...
              <p className="text-xs text-muted-foreground">
                ...
                . La clé reste dans votre navigateur et n'est pas stockée sur nos serveurs.
              </p>
            </div>
          </TabsContent>
        </Tabs>
