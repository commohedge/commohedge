...
export class MapContainer {
  ...
  private cachedMerchantCargoVessels: MerchantCargoVessel[] | null = null;
  ...
  private rehydrateActiveMap(): void {
    ...
    if (this.cachedMerchantCargoVessels) this.setMerchantCargoVessels(this.cachedMerchantCargoVessels);
  ...
  public setMerchantCargoVessels(vessels: MerchantCargoVessel[]): void {
    this.cachedMerchantCargoVessels = vessels;
    if (this.useGlobe) {
      this.globeMap?.setMerchantCargoVessels(vessels);
      return;
    }
    if (this.useDeckGL) {
      this.deckGLMap?.setMerchantCargoVessels(vessels);
    } else {
      this.svgMap?.setMerchantCargoVessels(vessels);
    }
  }
