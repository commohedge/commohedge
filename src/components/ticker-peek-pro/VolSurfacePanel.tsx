      ...
      {(phase === "loading-surface" || phase === "done") && (
        <>
          <div className="flex items-center gap-4 flex-wrap">
            ...
            {surfaceData && (
              <>
                ...
                >
                  {showMatrix ? "Masquer la matrice" : "Afficher la matrice IV"}
                </button>
                <button
          ...
          {showMatrix && surfaceData && (
            <DataCard title="Matrice IV (Strike × DTE)">
          ...
          >
            {phase === "loading-surface" ? (
              ...
              <EmptyState message="Aucune donnée IV disponible pour la surface 3D." />
            ) : !plotlyReady ? (
              <LoadingState message="Chargement du moteur 3D…" />
            ) : (
