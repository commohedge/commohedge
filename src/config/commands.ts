...
export const COMMANDS: Command[] = [
  ...
  { id: 'panel:politics', keywords: ['politics', 'geopolitics'], label: 'Panel: Politics', icon: '\u{1F30D}', category: 'panels' },
  ...
  { id: 'panel:fertilizer-news', keywords: ['fertilizer news', 'fertiliser news', 'urea potash', 'Argus fertilizers'], label: 'Fertilizer News', icon: '\u{1F331}', category: 'panels' },
