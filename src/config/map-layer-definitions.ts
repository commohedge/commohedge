...
export const LAYER_REGISTRY: Record<keyof MapLayers, LayerDefinition> = {
  ...
  cargoShips:               def('cargoShips',               '&#128741;', 'liveCargoAis',             'Live cargo AIS'),
...
const VARIANT_LAYER_ORDER: Record<MapVariant, Array<keyof MapLayers>> = {
  full: [
    ...
    'ais', 'cargoShips', 'tradeRoutes', 'flights', 'protests',
  ...
  commodity: [
    ...
    'ais', 'cargoShips', 'economic', 'fires', 'climate',
...
export const LAYER_SYNONYMS: Record<string, Array<keyof MapLayers>> = {
  ...
  vessel: ['ais', 'cargoShips'],
  cargo: ['cargoShips'],
  maritime: ['ais', 'cargoShips', 'waterways', 'tradeRoutes'],
  sea: ['ais', 'cargoShips', 'waterways', 'cables'],
