...
export const DEFAULT_PANELS: Record<string, PanelConfig> = {
  ...
  'fertilizer-news': { name: 'Fertilizer News', enabled: true, priority: 1 },
  // Operations & supply
...
export const DEFAULT_MAP_LAYERS: MapLayers = {
  ...
  cargoShips: true,     // Live AIS cargo/tanker (AISStream + Vite relay; AISSTREAM_API_KEY in dev)
  flights: false,
  // Infrastructure
  ...
  weatherRadar: false,
  openSeamarks: false,
  openSportMaritime: false,
  openGebcoBathymetry: false,
  openDepthContours: false,
  marineRegionsNe: false,
};
