...
export interface ChatSettings {
  ...
  /** Clé API Gemini (Google AI Studio). Si fournie, le modèle Gemini 2.5 Flash est utilisé avec cette clé. */
  geminiApiKey?: string;
}
...
/** Contexte commodities de l'app envoyé au chat pour que l'assistant utilise les données réelles. */
export interface AppCommodityContext {
